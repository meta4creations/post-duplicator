...
**Live:** https://www.metaphorcreations.com/article/post-duplicator/general/settings/  
**Wiki:** [wiki/Settings.md](../../wiki/Settings.md)

**Gutenberg notes:** Use Group + Heading per main section (**Defaults**, **Permissions**, **Advanced**). Long field lists read well with columns or separated Groups if the theme supports them.
...
<!-- IMAGE(placeholder): settings-page-overview.png — Full Settings > Post Duplicator screen or split: sidebar menu + main panel -->
...
<!-- IMAGE(placeholder): settings-defaults-section.png — Defaults section fields visible -->
...
<!-- IMAGE(placeholder): settings-offset-date.png — Offset Date controls expanded -->

## Permissions Section

Control which user roles can duplicate posts and what they can duplicate.

<!-- IMAGE(placeholder): settings-permissions-section.png — Role/capability checkboxes -->
...
_Use a Code block (or monospace paragraph) on the live site for the snippet._

<!-- IMAGE(placeholder): settings-advanced-page-slugs.png — Additional Admin Screens / Page Slugs textarea -->
...
<!-- IMAGE(placeholder): settings-advanced-status-toggles.png — Advanced subsection for draft/pending/private/password/future -->
