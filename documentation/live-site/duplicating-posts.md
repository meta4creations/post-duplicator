...
**Live:** https://www.metaphorcreations.com/article/post-duplicator/general/duplicating-posts/  
**Wiki:** [wiki/Duplicating-Posts.md](../../wiki/Duplicating-Posts.md)

**Gutenberg notes:** Add a Table of Contents block after the intro. Use Group blocks per major `##` section for clearer spacing on the theme.

---

This guide explains how to duplicate posts using the Post Duplicator plugin.

<!-- IMAGE(placeholder): duplicating-posts-overview-hero.png — Optional hero: plugin context or list screen establishing “where duplication happens” -->
...
<!-- IMAGE(placeholder): duplicating-posts-list-row-actions.png — Posts (or Pages) list with row actions visible, highlighting Duplicate link -->
...
<!-- IMAGE(placeholder): duplicating-posts-gutenberg-toolbar.png — Block editor top toolbar with Duplicate Post control visible -->
...
<!-- IMAGE(placeholder): duplicating-posts-classic-publish-box.png — Classic editor Publish meta box with duplicate button -->
...
<!-- IMAGE(placeholder): duplicating-posts-bulk-actions.png — List table with rows checked and Bulk Actions dropdown showing Duplicate action -->

## The Duplication Modal

When you click to duplicate a post, a modal window opens with various options. Here's what you'll see:

<!-- IMAGE(placeholder): duplicating-posts-modal-basic.png — Duplication modal, Basic settings visible (title, slug, featured image, post type, status, author, date) -->
...
<!-- IMAGE(placeholder): duplicating-posts-modal-advanced.png — Modal with Advanced / taxonomies / custom meta options visible -->
...
<!-- IMAGE(placeholder): duplicating-posts-modal-multiple-clones.png — Modal with multiple clones / Create Multiple Copies enabled -->
...
<!-- IMAGE(placeholder): duplicating-posts-modal-bulk.png — Bulk duplication modal with multiple posts listed -->
...
<!-- IMAGE(placeholder): duplicating-posts-success.png — Success state: View Post / Edit Post actions -->
...
_Use a Table block on the live site for this comparison._
...
<!-- IMAGE(placeholder): duplicating-posts-included-vs-not.png — Optional simple diagram or two-column callout for included vs not duplicated -->
