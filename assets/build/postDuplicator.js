...
/* harmony import */ var _components_DuplicateModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/DuplicateModal */ "./src/components/DuplicateModal.js");
/* harmony import */ var _utils_duplicatePost__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/duplicatePost */ "./src/utils/duplicatePost.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__);
...
const DuplicatePostHandler = () => {
  ...
  const [currentPost, setCurrentPost] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const handleDuplicate = async (settings, callbacks) => {
    if (!currentPost) return;
    await (0,_utils_duplicatePost__WEBPACK_IMPORTED_MODULE_3__.duplicatePost)(currentPost.id, settings, {
      onSuccess: result => {
      ...
      onError: error => {
        showSnackbar(`Error duplicating post: ${error.message || error.data?.message || 'Unknown error'}`, 'error');
    ...
    const handleClick = async e => {
      if (e.target.classList.contains('m4c-duplicate-post')) {
        ...
        try {
          ...
          // Fetch author data
          const authorResponse = await fetch(`${postDuplicatorVars.restUrl.replace('post-duplicator/v1/', 'wp/v2/')}users/${post.author}`, {
            headers: {
              'X-WP-Nonce': postDuplicatorVars.nonce
            }
          });
          ...
          if (post.featured_media && post.featured_media > 0) {
            try {
              const mediaResponse = await fetch(`${postDuplicatorVars.restUrl.replace('post-duplicator/v1/', 'wp/v2/')}media/${post.featured_media}`, {
                headers: {
                  'X-WP-Nonce': postDuplicatorVars.nonce
                }
              });
          ...
          let customMeta = [];
          try {
            const postDataResponse = await fetch(`${postDuplicatorVars.restUrl}post-data/${postId}`, {
              headers: {
                'X-WP-Nonce': postDuplicatorVars.nonce
              }
            });
          ...
          setCurrentPost({
            ...
            // Add author ID for settings component
          ...
          showSnackbar('Error loading post data. Please try again.', 'error');
        }
      }
    };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_components_DuplicateModal__WEBPACK_IMPORTED_MODULE_2__["default"], {
    isOpen: isModalOpen,
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const root = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createRoot)(modalRoot);
  root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(DuplicatePostHandler, {}));
});
})();

/******/ })()
;
//# sourceMappingURL=postDuplicator.js.map